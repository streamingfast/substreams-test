...
DATABASE_PROTO="$ROOT/../substreams-entity-change/proto"
...
function main() {
  ...
  generate "entity/v1/entity.proto"
...
function generate() {
    ...
    for file in "$@"; do
      protoc -I$DATABASE_PROTO \
        ...
        --go_opt="Mentity/v1/entity.proto=github.com/streamingfast/substreams-test/pb;pbentities" \
         $base$file
    done
}
